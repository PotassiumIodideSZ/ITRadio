"""
URL configuration for ITRadioBackend project.
...
from userProfile.views import ProfileViewSet, AddSong, DeleteSong, GetLikedSongs
...
urlpatterns = [
    ...
    path('delete-song/', DeleteSong, name='delete-songs'),
